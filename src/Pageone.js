...
<stop offset="1" stop-color="#FF864C"/>
        ...
        <div class="flex-grow pl-6">
          <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Invite your friend</h2>
          <p class="leading-relaxed text-base">Share the link tutedude.com with your friends  </p>
...
<stop offset="1" stop-color="#FF864C"/>
        ...
        <div class="flex-grow pl-6">
          <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Friend purchases any courses</h2>
          <p class="leading-relaxed text-base">Using your REFERRAL CODE in the payments page </p>
